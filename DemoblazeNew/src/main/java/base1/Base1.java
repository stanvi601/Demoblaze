...
//	   code to set up the browser
		...
		public void setup()
		{
			...
			try
			{
				prop.load(new FileInputStream("src\\main\\java\\config1\\config1.properties"));
			}
			catch(Exception e)
			{
				e.printStackTrace();
			...
			report = new ExtentReports();
		 	...
		 	report.setSystemInfo("User Name", "Team");
		 	   
		 	exthtml.config().setDocumentTitle("Demoblaze");
		 	exthtml.config().setReportName("Demoblaze Functional Testing");
